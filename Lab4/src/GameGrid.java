...
public class GameGrid
{
    ...
    private LinkedList oLinkedList = new LinkedList();
    ...
    public void run()
    {
        ...
        while(!gameOver)
        {
            oLinkedList.addNode(player.getUserRow(), player.getUserCol());
        ...
        {
            Node oNode = oLinkedList.removeNode();

            gameGrid[oNode.xPosition][oNode.yPosition] = moveCount + 2;

            moveCount++;
        }

        printGameBoard();
        System.out.println("You made " + moveCount + " moves before blowing up.");
